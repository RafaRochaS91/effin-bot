const versions = {
    DISC: 'https://www.saturn.de/de/product/_sony-playstation%C2%AE5-2661938.html',
    DIGITAL: 'https://www.saturn.de/de/product/_sony-playstation%C2%AE5-digital-edition-2661939.html',
};


async function buyOnSaturn(isDigital) {
